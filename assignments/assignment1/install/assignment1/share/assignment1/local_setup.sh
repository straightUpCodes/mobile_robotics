...
: ${AMENT_CURRENT_PREFIX:="/home/fred/mobile_robotics/assignments/assignment1/install/assignment1"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/assignment1/environment/library_path.sh"
